...
import { PersonService } from '../../service/PersonService.component'; // Asegúrate de que la ruta sea correcta
...
export class PersonajesComponent implements AfterViewInit, OnChanges {
  ...
  displayedColumns: string[] = ['id', 'foto', 'nombre', 'usuario', 'contrasenia', 'rol', 'acciones'];
